...
struct gridwise_generic_reduce_pad_and_store<ReductionMethod_t::DirectThreadWise, src_need_padding, dst_need_padding>
{
     ...
     __device__ static inline void RunMethod(int GridSize, int BlkGroupSize, const src2dDescType &src2dDesc, const dst1dDescType &dst1dDesc,
...
template <bool src_need_padding, bool dst_need_padding>
struct gridwise_generic_reduce_pad_and_store<ReductionMethod_t::DirectWarpWise, src_need_padding, dst_need_padding>
{
     static constexpr index_t GredAccessesPerThreadInWarp  = CK_PARAM_ACCESSES_PER_THREAD_INWARP;  // tunable
     static constexpr index_t BlockSize = CK_PARAM_BLOCKSIZE; // tunable
...
template <bool src_need_padding, bool dst_need_padding>
struct gridwise_generic_reduce_pad_and_store<ReductionMethod_t::BlockWise, src_need_padding, dst_need_padding>
{
     static constexpr index_t GredAccessesPerThreadInBlock = CK_PARAM_ACCESSES_PER_THREAD_INBLOCK; // tunable
     static constexpr index_t BlockSize = CK_PARAM_BLOCKSIZE; // tunable
...
template <bool src_need_padding, bool dst_need_padding>
struct gridwise_generic_reduce_pad_and_store<ReductionMethod_t::MultiBlock, src_need_padding, dst_need_padding>
{
     static constexpr index_t GredAccessesPerThreadInBlock = CK_PARAM_ACCESSES_PER_THREAD_INBLOCK; // tunable
     static constexpr index_t BlockSize = CK_PARAM_BLOCKSIZE; // tunable
