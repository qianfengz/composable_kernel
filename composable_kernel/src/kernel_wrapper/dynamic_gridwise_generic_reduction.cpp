...
extern "C" __global__ void gridwise_generic_reduce_1(size_t *srcLengths, size_t *srcStrides, size_t *dstLengths, *dstStrides, 
		                                     float alpha,
...
extern "C" __global__ void gridwise_generic_reduce_2(size_t *srcLengths, size_t *srcStrides, size_t *dstLengths, *dstStrides,
		                                     float alpha,
                                                     const void* p_src_global,
                                                     float beta,
                                                     void* p_dst_global,
